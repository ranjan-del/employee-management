...
3.Enable Cloud Firestore under the Database section
4.Get the Firebase configuration details
5.Open src/environments/environment.ts and update it with your Firebase credentials:
```
